...
public class EventControllerTests extends BaseTest {
                ...
                mockMvc.perform(post("/api/events/")
                                ...
                                .andDo(document("create-event",
                                                links(
                                                                ...
                                                                linkWithRel("query-events")
                                                                                .description("link to query events"),
                                                                linkWithRel("update-event").description(
                                                ...
                                                requestFields(
                                                                ...
                                                                fieldWithPath("limitOfEnrollment")
                                                                                .description("limit of enrolmment")),
                                                responseHeaders(
        ...
        @Test
        @DisplayName("30개의 이벤트를 10개씩 1번째 페이지 조회하기 + 100 <= basePrice <= 200 and eventStatus == EventStatus.PUBLISHED")
        public void getEventTargetWithAuthentication() throws Exception {
                // Given
                IntStream.range(0, 30).forEach(this::generateEvent);
